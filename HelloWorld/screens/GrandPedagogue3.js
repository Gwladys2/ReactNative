...
export default function LessonScreen({ navigation }) {
    ...
    return (
       <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                   <Text style={styles.link} onPress={() => navigation.navigate('CoursMontessori1')}> 📖 Voir le cours</Text>
                    <Text style={styles.titre}>Les Grands Pédagogues: Montessori partie 1/2</Text>
                ...
                <>
                    ...
                    <Button title="Passer à Montessori partie 2" onPress={() => navigation.navigate('GrandPedagogue4')} /> 
                </>
            )}
       ...
       <View style={styles.linkContainer}>
                                 <Text style={styles.link} onPress={() => navigation.navigate('GrandPedagogue')}> 🌼Freinet 1</Text>
                                                               ...
                                                               <Text style={styles.link} onPress={() => navigation.navigate('GrandPedagogue3')}>🌼 Montessori 1</Text>
                                                                ...
                                                                <Text style={styles.link} onPress={() => navigation.navigate('GrandPedagogue7')}>🌼 Oury </Text>
                                                                <Text style={styles.link} onPress={() => navigation.navigate('GrandPedagogue8')}>🌼 Pédagogie Institutionnelle</Text>
