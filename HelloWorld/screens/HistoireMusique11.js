...
import questions from '../questions/HistoireMusique/serie11.json';
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    ...
                    <Text style={styles.titre}>Histoire de la Musique: La symphonie dans l’Allemagne du XIXᵉ siècle & Beethoven</Text>
