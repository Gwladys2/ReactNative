...
import questions from '../questions/HistoireMusique/serie1.json';
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    ...
                    <Text style={styles.titre}>Histoire de la Musique: l’aube de l’âge de la musique classique au XVIIIe siècle</Text>
