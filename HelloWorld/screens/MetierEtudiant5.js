...
import questions from '../questions/MetierEtudiant/serie5.json';
...
export default function LessonScreen({ navigation }) {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    <Text style={styles.titre}>Métier de l'étudiant:  Lire comprendre et synthétiser un article scientique</Text>
         ...
         <View style={styles.linkContainer}>
                                                                ...
                                                                <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant1')}>  🎇  Travail du Groupe et gestion du temps</Text>
                                                                <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant2')}>  🎇 Reconnaitre les normes académiques de rédaction</Text>
                                                                <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant3')}>  🎇 Comment lire un article scientifique</Text>
                                                                <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant4')}>  🎇  Distinguer les différents types d'écrits</Text>
                                                                <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant5')}>  🎇 Lire comprendre et synthétiser un article scientique</Text>
                                                                <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant6')}>  🎇 Comment faire une fiche de lecture</Text>
                                                                 <Text style={styles.link} onPress={() => navigation.navigate('MetierEtudiant7')}> 🎇Comment faire un oral</Text>
                                                                </View>
