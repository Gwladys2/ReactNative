...
import questions from '../questions/ScienceEducation/GrandPedagogue/serie6.json';
...
export default function LessonScreen({ navigation }) {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    <Text style={styles.link} onPress={() => navigation.navigate('CoursNeill')}> 📖 Voir le cours</Text>
                    <Text style={styles.titre}>Les Grands Pédagogues: Alexander Neill partie 2</Text>
