...
import questions from '../questions/MetierEtudiant/serie2.json';
...
export default function LessonScreen({ navigation }) {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    <Text style={styles.titre}>Métier de l'étudiant: Reconnaitre les normes académiques de rédaction</Text>
