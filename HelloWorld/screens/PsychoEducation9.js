...
import questions from '../questions/psychoDevApp/serie9.json';
...
export default function LessonScreen({ navigation }) {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                <Text style={styles.link} onPress={() => navigation.navigate('CoursPsychoEducation')}></Text>
                    <Text style={styles.titre}>Psychologie du développement et de l'éducation: Les neurosciences</Text>
