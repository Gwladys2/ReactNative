...
export default function LessonScreen({ navigation }) {
    ...
    return (
         <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                <Text style={styles.link} onPress={() => navigation.navigate('CoursFreinet1')}>📖 Voir le cours</Text>
                    <Text style={styles.titre}>Les Grands Pédagogues Freinet partie 1/2</Text>
                ...
                <>
                    ...
                    <Button title="passer à Freinet partie 2" onPress={() => navigation.navigate('GrandPedagogue2')} />
                </>
            )}
