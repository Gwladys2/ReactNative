...
import questions from '../questions/HistoireMusique/serie8.json';
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    ...
                    <Text style={styles.titre}>Histoire de la Musique: Symphonie n°35 K.385 Haffner Premier mouvement de Mozart</Text>
