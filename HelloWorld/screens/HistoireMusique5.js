...
import questions from '../questions/HistoireMusique/serie5.json';
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    ...
                    <Text style={styles.titre}>Histoire de la Musique: Symphonie n°8 en sol majeur « Le Soir » de Joseph Haydn</Text>
