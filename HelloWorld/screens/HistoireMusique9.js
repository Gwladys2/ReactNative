...
import questions from '../questions/HistoireMusique/serie9.json';
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    ...
                    <Text style={styles.titre}>Histoire de la Musique: Symphonie n°39 K.543 mi bémol majeur de Mozart</Text>
