...
import questions from '../questions/HistoireMusique/serie7.json';
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!showRestart ? (
                <>
                    ...
                    <Text style={styles.titre}>Histoire de la Musique: Symphonie n°25 en sol mineur K.183 de Mozart</Text>
